...
defined("MATE_THEME_API_BUCKET_LIMIT") or define("MATE_THEME_API_BUCKET_LIMIT", 32);
...
defined("MATE_THEME_API_MAX_NAME_LENGTH") or define("MATE_THEME_API_MAX_NAME_LENGTH", 255);
defined("MATE_THEME_API_MAX_DESCRIPTION_LENGTH") or define("MATE_THEME_API_MAX_DESCRIPTION_LENGTH", 4096);
