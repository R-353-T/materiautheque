...
export class FUnit extends BaseForm2 {
    ...
    get formGroup() { return this.formGroups['unit']; }
    get id() { return this.formGroups['unit'].get('id') as FormControl; }
    get name() { return this.formGroups['unit'].get('name') as FormControl; }
    get description() { return this.formGroups['unit'].get('description') as FormControl; }
    get valueList() { return this.formGroups['unit'].get('valueList') as FormArray<FormControl>; }
